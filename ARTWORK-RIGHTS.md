# Artwork Rights and Stewardship

This document describes the provenance of the original artwork behind the Palembang Graphic System and how the repository maintainer approaches rights in it. It applies to the original painting, the reference photographs in `reference/`, `source/Palembang.fig` and its extracted design data, and the canonical PNG assets in `assets/canonical/png/`. It does not apply to source code, which is covered by the MIT License described in [`LICENSE.md`](LICENSE.md).

This document is a statement of intent and stewardship. It is not a legal assignment of copyright, and it does not by itself change who holds what rights under applicable law.

## Origin

The original painting was hand-painted by a friend of the repository maintainer and given to the maintainer personally as a gift.

The artist's identity and personal details are intentionally not published.

## Current stewardship

The maintainer currently possesses the original physical painting and controls this repository and the digital Palembang assets derived from it. The maintainer did not create the original artwork and does not claim to be its artist.

A gift of a physical painting is not, by itself, a transfer of copyright in the work. The maintainer holds and exercises only the rights they are legally entitled to hold as a result of the gift and their own subsequent work — including the design translation captured in `source/Palembang.fig`, `docs/specification.md`, `tokens/palembang.v1.json`, and the canonical rendered assets — and makes no broader claim.
...
No additional provenance or personal information about the artist will be published without the artist's consent.
